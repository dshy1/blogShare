					...
					<div class="portfolio-box">
						@foreach($portfolios as $port)
							<div class="project-post">
								<img src="{{ asset($path.'storage/images/clientes/'.$port->image) }}"  alt="" />
								<div class="hover-box">
									...
									<ul class="project-links">
										...
										<li><a href="{{ asset($path.'storage/images/clientes/'.$port->image) }}" class="zoom-image"><i class="fa fa-search"></i></a></li>
									</ul>
								</div>
							</div>
						@endforeach
